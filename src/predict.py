...
def predict():
    ...
    predictor = DefaultPredictor(cfg)
    evaluator = COCOEvaluator("master_dataset_val", cfg, False, output_dir = train_path)
    ...
    results_logger(det_metrics,my_metrics,det_metrics_val,my_metrics_val,output_pred,params)
